package main.java.edu.brown.cs.graph;

import java.util.Set;

/**
 * An interface that parses information from a data source into Objects to be stored in a main.java.edu.brown.cs.graph.graph.
 */
